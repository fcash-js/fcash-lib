...
var HDPublicKey = fcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = fcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(fcore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(fcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      fcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = fcore.PublicKey.fromPoint;
      fcore.PublicKey.fromPoint = function() {
        fcore.PublicKey.fromPoint = unstubbed;
