...
var HDPrivateKey = fcash_base.HDPrivateKey;
var HDPublicKey = fcash_base.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = fcash_base.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(fcash_base.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(fcash_base.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      fcash_base.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = fcash_base.PublicKey.fromPoint;
      fcash_base.PublicKey.fromPoint = function() {
        fcash_base.PublicKey.fromPoint = unstubbed;
